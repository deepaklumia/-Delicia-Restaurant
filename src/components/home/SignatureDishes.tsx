...
import { Sparkles, Plus, Wine, Info, Flame, Check } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="space-y-3 max-w-2xl">
            ...
            <p className="text-sm text-cream-200/70 font-light">
              Each dish embodies months of refinement, rare provenance ingredients, and exquisite visual composition.
            </p>
          </div>
          ...
          {SIGNATURE_DISHES.slice(0, 6).map((dish) => (
            ...
            >
              ...
              <div className="relative h-64 w-full overflow-hidden">
                ...
                {/* Price Pill */}
                <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-obsidian-950/85 border border-gold-500/40 text-gold-300 font-serif font-bold text-sm backdrop-blur-md">
                  ${dish.price}
                </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    {dish.dietary.slice(0, 2).map((d) => (
                      <span key={d} className="text-[10px] uppercase font-semibold text-gold-400/70 tracking-wider">
                        • {d}
                      </span>
                    ))}
                  </div>
                  ...
                  {dish.frenchName && (
                    <p className="text-xs italic text-gold-400/75 font-serif line-clamp-1 mt-0.5">
                      {dish.frenchName}
                    </p>
                  )}
